...
router.post('/xlsx/extract/csv', [
  ...
  (req, res) => {
    /**
     * This route requires the sheetRange and orientation to match the type
     * of XLSX file passed along. This could be fleshed out down the road but
     * the validation is too complex to include here for now.
     */
    const file = req.file;
    if (file) {
