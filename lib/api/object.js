...
router.post('/multi/:db/:collection', bodyParser.json(), (req, res) => {
  const db = req.params.db;
  const collection = req.params.collection;
...
// Aggregate objects
router.post('/:db/:collection/aggregate', bodyParser.json(), (req, res) => {
  const db = req.params.db;
  const collection = req.params.collection;
...
// Count objects
router.post('/:db/:collection/count', bodyParser.json(), (req, res) => {
  const db = req.params.db;
  const collection = req.params.collection;
...
router.post('/:db/:collection/distinct/:field', bodyParser.json(), (req, res) => {
  const db = req.params.db;
  const collection = req.params.collection;
...
// Find Objects
router.post('/:db/:collection/find', bodyParser.json(), (req, res) => {
  const db = req.params.db;
  const collection = req.params.collection;
...
// Create an object
router.post('/:db/:collection', bodyParser.json(), (req, res) => {
  const payload = req.body;
...
router.post('/:db/:collection/:id', bodyParser.json(), (req, res) => {
  const db = req.params.db;
  const collection = req.params.collection;
  const id = req.params.id;
  const payload = req.body;
...
router.put('/:db/:collection/:id', bodyParser.json(), (req, res) => {
  const db = req.params.db;
  const collection = req.params.collection;
  const id = req.params.id;
  const payload = req.body;
